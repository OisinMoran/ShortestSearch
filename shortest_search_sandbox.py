...
def search_suggestions(url, num_results=1):
    ## Read data from URL
    ...
    return sorted_phrases[0:num_results]

print(search_suggestions("https://www.ted.com/talks/david_eagleman_can_we_create_new_senses_for_humans", 5))
print(search_suggestions("http://www.paulgraham.com/writing44.html"))
